 ...
 * done button.
 */
class TodoUIIndividualTaskCardDisplayWidget extends StatelessWidget{
  
  // Declared the variables
  final TodoModel todo;

  // Constructor 
  TodoUIIndividualTaskCardDisplayWidget({
    required this.todo, 
  });
  ...
  void displayTodoContent(BuildContext context, TodoModel todo) => Navigator.of(context).push(
    MaterialPageRoute(builder: (context) => DisplayTodoContentPage(todo:todo)),
  );
  ...
  void openStatusTodo(BuildContext context, TodoModel todo){
    final provider = Provider.of<TodosStorage>(context, listen:false);
    provider.toggleTodoIsOpenStatus(todo);
  }
  ...
  void inProgressStatusTodo(BuildContext context, TodoModel todo){
    final provider = Provider.of<TodosStorage>(context, listen:false);
    provider.toggleTodoInProgressStatus(todo);
  }
  ...
  void completedStatusTodo(BuildContext context, TodoModel todo){
    final provider = Provider.of<TodosStorage>(context, listen:false);
    provider.toggleTodoIsCompletedStatus(todo);
  }
