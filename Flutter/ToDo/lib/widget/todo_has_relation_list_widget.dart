...
/***
 * This is the widget class for the todos with relationship.
 * How the cards are displayed and the scrolling affect
 *
 * Source: https://api.flutter.dev/flutter/widgets/ListView/ListView.separated.html
 */
class TodoHasRelationListWidget extends StatelessWidget{

  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<TodosStorage>(context);
    // The state to be in this class
    final todos = provider.todosHasRelation;
