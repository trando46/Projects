...
class DisplayTodoContentPage extends StatefulWidget{
  final TodoModel todo;
  DisplayTodoContentPage({
    required this.todo,
  });
 ...
 */
class _DisplayTodoContentState extends State<DisplayTodoContentPage> {
  final TodoModel todo;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //TODO: uncomment this when wanting to have many to many relationship
      // TODO: but as of now I assume it is 1 to many relationships.
      //Want to add the button to add additional relations. This will be on hold
      /*floatingActionButton: FloatingActionButton(
        ...
        onPressed: () => showDialog(
          ...
          context: context,
          builder: (context) =>(TodoAddingAdditionalRelationsWidget()),
        ),
      ),*/
  ...
  void displayTodoContent(BuildContext context, TodoModel todo) => Navigator.of(context).push(
    MaterialPageRoute(builder: (context) => DisplayTodoContentPage(todo:relatedTodo(context))),
  );
  ...
  void removeRelationContent(BuildContext context, TodoModel todo) {
    final provider = Provider.of<TodosStorage>(context,listen: false);
    provider.removeRelationTodo(todo);
    //provider.updateTodo(widget.todo,title,description,relationType=dropdownRelationValue, relatedTo);
