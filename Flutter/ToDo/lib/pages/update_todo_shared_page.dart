 ...
 */
class UpdateTodoSharedPage extends StatefulWidget{
  ...
  // Constructor
  UpdateTodoSharedPage({
    required this.todo,
  });

  @override
  _UpdateTodoSharedPageState createState() => _UpdateTodoSharedPageState();
}

/***
 * Private class for the state of edit todos page.
 */
class _UpdateTodoSharedPageState extends State<UpdateTodoSharedPage> {
